...
declare variable $init:version := "20180312-OR";
...
let $isOuverture:= if(not($initFile/Campagne/Traitement/Type) 
or $initFile/Campagne/Traitement/Type/text()='Ouverture' 
or $initFile/Campagne/Traitement/Type/text()='Initialisation' 
or $initFile/Campagne/Traitement/Type/text()='Ouverture sans courrier' 
or $initFile/Campagne/Traitement/Type/text()='Ouverture avec courrier'
or $initFile/Campagne/Traitement/Type/text()='Courrier Entrée')
then()else(error(xs:QName('colerr:notTreatable'),"le fichier de perso "||$uriFichier||" n'est pas à traiter","(traitement : " ||$initFile/Campagne/Traitement/Type||")" ))
